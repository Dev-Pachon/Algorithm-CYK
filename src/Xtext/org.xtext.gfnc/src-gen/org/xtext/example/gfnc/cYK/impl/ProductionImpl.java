...
public class ProductionImpl extends MinimalEObjectImpl.Container implements Production
{
  ...
  {
    return CYKPackage.Literals.PRODUCTION;
  }
  ...
  public NotificationChain basicSetLeft(NonTerminal newLeft, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CYKPackage.PRODUCTION__LEFT, oldLeft, newLeft);
  ...
  public void setLeft(NonTerminal newLeft)
  {
    if (newLeft != left)
    {
      ...
      if (left != null)
        msgs = ((InternalEObject)left).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CYKPackage.PRODUCTION__LEFT, null, msgs);
      if (newLeft != null)
        msgs = ((InternalEObject)newLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CYKPackage.PRODUCTION__LEFT, null, msgs);
      msgs = basicSetLeft(newLeft, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CYKPackage.PRODUCTION__LEFT, newLeft, newLeft));
  }
