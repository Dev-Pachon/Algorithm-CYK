...
public interface CYKPackage extends EPackage
{
   ...
   * @ordered
   */
  int RIGHT_FEATURE_COUNT = LAMBDA_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int SIMPLE__RIGHT = RIGHT__RIGHT;
   ...
   * @ordered
   */
  int SIMPLE__ALPHA = RIGHT_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int SIMPLE_FEATURE_COUNT = RIGHT_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int BINARY__RIGHT = RIGHT__RIGHT;
   ...
   * @ordered
   */
  int BINARY__FIRST = RIGHT_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int BINARY__SECOND = RIGHT_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int BINARY_FEATURE_COUNT = RIGHT_FEATURE_COUNT + 2;
  ...
  /**
   * Returns the meta object for the attribute '{@link org.xtext.example.gfnc.cYK.Simple#getAlpha <em>Alpha</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Alpha</em>'.
   * @see org.xtext.example.gfnc.cYK.Simple#getAlpha()
   * @see #getSimple()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link org.xtext.example.gfnc.cYK.NonTerminal#getVar <em>Var</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Var</em>'.
   * @see org.xtext.example.gfnc.cYK.NonTerminal#getVar()
   * @see #getNonTerminal()
   * @generated
   */
